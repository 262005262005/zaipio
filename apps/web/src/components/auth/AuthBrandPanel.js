...
exports.default = AuthBrandPanel;
const STATS = [
...
const TESTIMONIAL = {
    quote: '"Before ZAIPIO, I spent 2 hours every morning sorting labels. Now it\'s done at 12:00 automatically — I didn\'t even open my laptop."',
    name: 'Rohan Mehta',
    business: 'Seller on Amazon & Flipkart · ₹40L/month GMV',
    initials: 'RM',
};
function AuthBrandPanel() {
    return (<div className="hidden lg:flex lg:w-[45%] xl:w-[42%] bg-navy flex-col justify-between p-10 xl:p-14 relative overflow-hidden">
      ...
      <div className="relative z-10 space-y-5">
        ...
        <div className="grid grid-cols-3 gap-4">
          {STATS.map((s) => (<div key={s.label} className="bg-white/[0.07] border border-white/10 rounded-2xl p-4">
        ...
        ].map((p) => (<div key={p.letter} className="w-8 h-8 rounded-lg flex items-center justify-center text-white font-black text-sm" style={{ background: p.color }}>
              {p.letter}
            </div>))}
...
//# sourceMappingURL=AuthBrandPanel.js.map