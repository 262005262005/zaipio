...
export default function TopBar({ onOpenMobile }: TopBarProps) {
  ...
  return (
    <header className="h-16 bg-white border-b border-navy/10 flex items-center justify-between px-4 sm:px-6 shrink-0 z-10">
      ...
      <div className="flex items-center gap-3">
        {onOpenMobile && (
          <button
            ...
            className="lg:hidden p-2 rounded-xl bg-navy/5 hover:bg-navy/10 text-navy font-bold text-lg leading-none"
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        {/* Notifications */}
        <button
          className="relative w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center rounded-xl hover:bg-navy/10 transition-colors text-navy/60"
