...
function Problems() {
    return (<section className="py-24 bg-navy text-white border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-[#041a2e] border border-white/15 rounded-3xl p-8 sm:p-12 shadow-2xl backdrop-blur-md grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6 text-left">
            ...
            <div className="pt-2">
              <a href="/payments" className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-500 text-white font-bold text-sm px-6 py-3 rounded-xl shadow-lg transition-all">
          ...
          <div className="bg-navy p-6 sm:p-8 rounded-2xl border border-white/15 space-y-6 text-left">
            ...
            <div className="space-y-4">
              {LOSS_ITEMS.map((item) => (<div key={item.label} className="space-y-1.5">
