...
function Features() {
    return (<section id="features" className="py-24 bg-navy text-white overflow-hidden relative border-t border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-28 relative z-10">
        ...
        {ZIGZAG_FEATURES.map((f, index) => (<div key={f.title} className={`flex flex-col lg:flex-row items-center gap-12 lg:gap-16 ${f.reverse ? 'lg:flex-row-reverse' : ''}`}>
            {/* Text Column */}
            <div className="flex-1 space-y-6 text-left">
              ...
              <ul className="space-y-3 pt-2">
                {f.points.map((pt) => (<li key={pt} className="flex items-center gap-3 text-sm font-semibold text-white/90">
              ...
              <div className="pt-4">
                <a href={f.href} className="inline-flex items-center gap-2 bg-gradient-to-r from-accent to-sky-600 text-white font-bold text-sm px-6 py-3 rounded-xl shadow-[0_0_20px_rgba(14,165,233,0.4)] hover:brightness-110 hover:-translate-y-0.5 transition-all">
                  {f.cta}
                </a>
              </div>
            </div>
            ...
            <div className="flex-1 w-full">
              <div className="relative bg-[#041a2e] border border-white/15 rounded-2xl shadow-2xl p-6 overflow-hidden group hover:border-accent/50 transition-all">
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  {f.mockupType === 'orders' && (<div className="space-y-3 font-outfit text-left">
                  ...
                  {f.mockupType === 'claims' && (<div className="space-y-3 font-outfit text-left">
                      <div className="flex items-center justify-between bg-navy-950 p-3 rounded-xl border border-white/10">
                  ...
                  {f.mockupType === 'payments' && (<div className="space-y-3 font-outfit text-left">
                      <div className="flex items-center justify-between bg-navy-950 p-3 rounded-xl border border-white/10">
                  ...
                  {f.mockupType === 'inventory' && (<div className="space-y-3 font-outfit text-left">
                      <div className="flex items-center justify-between bg-navy-950 p-3 rounded-xl border border-white/10">
                  ...
                  {f.mockupType === 'profit' && (<div className="space-y-3 font-outfit text-left">
                      <div className="flex items-center justify-between bg-navy-950 p-3 rounded-xl border border-white/10">
