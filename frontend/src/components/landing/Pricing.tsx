        ...
        <div className="text-center mb-14">
          ...
          <div className="inline-flex items-center gap-3 bg-navy/5 rounded-full p-1">
            <button
              ...
              className={`px-5 py-2 rounded-full text-sm font-semibold transition-all ${!annual ? 'bg-white text-navy shadow-navy-sm' : 'text-navy/50'}`}
            >
              Monthly
            </button>
            <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 items-start">
          {TIERS.map((t) => (
            ...
            >
              ...
              <a
                href="#"
                className={`block text-center py-3 rounded-xl font-bold text-sm mb-6 transition-all ${
                  t.popular
                    ? t.ctaStyle
                    : t.ctaStyle
                }`}
              ...
              <ul className="space-y-2">
                {t.features.map((f) => (
                  <li key={f} className={`flex items-start gap-2 text-sm ${t.popular ? 'text-white/85' : 'text-navy/70'}`}>
                ...
                {t.missing.map((f) => (
                  <li key={f} className={`flex items-start gap-2 text-sm ${t.popular ? 'text-white/30' : 'text-navy/25'}`}>
