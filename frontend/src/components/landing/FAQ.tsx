...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="py-24 bg-navy/[0.02] border-t border-navy/10">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-3">
          {FAQS.map((faq, i) => (
            <div
              key={i}
              className="bg-white rounded-2xl border border-navy/10 overflow-hidden hover:border-navy/20 transition-colors"
            >
              <button
