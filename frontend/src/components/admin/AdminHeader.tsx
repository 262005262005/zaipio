    ...
    <header className="h-16 border-b border-slate-800 bg-slate-950 px-6 flex items-center justify-between shrink-0">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          <input
            type="text"
            placeholder="Search seller, email, or order ID..."
            className="bg-slate-900 border border-slate-800 rounded-xl px-3.5 py-1.5 text-xs text-slate-200 placeholder:text-slate-500 focus:outline-none focus:border-red-500/50 w-64"
          />
        </div>
